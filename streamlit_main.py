...
if sp_connect_button:
    try:
        ...
        top_artists = get_current_user_top_artists(sp, limit=10)
        ...
        for artist in top_artists:
            ...
            with st.expander(f"{len(artist_events)} events were found for {artist}", expanded=False):
